...
import static edu.illinois.cs.cs124.ay2023.mp.models.Summary.filter;
...
public final class MainActivity extends AppCompatActivity
  ...
  private final Consumer<ResultMightThrow<List<Summary>>> summaryCallback =
      (result) -> {
        try {
          ...
          // this might be a good place to sort this list
  ...
  public boolean onQueryTextChange(@NonNull String query) {
    List<Summary> filteredSummaries = filter(summaries, query);
